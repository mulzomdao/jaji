<?
    $page_name = str_replace('.php', '', str_replace('/', '', $_SERVER['REQUEST_URI']));
    $page_name_array = explode("_", $page_name);
    $page_group_name = $page_name_array[0];
    $page_group_code = "00";

    switch ($page_group_name) {
        case "member":
        case "group":
            $page_group_code = "99";
            break;
        ...
        <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element">
                    <span>
                        <img alt="image" class="img-circle" src="image/profile.png" width="50"/>
                    </span>
                    ...
                    <ul class="dropdown-menu animated fadeInRight m-t-xs">
                        ...
                        <li><a href="inspinia/mailbox.html">Mailbox</a></li>
                        <li class="divider"></li>
                        <li><a href="inspinia/login.html">Logout</a></li>
                    </ul>
                </div>
                <div class="logo-element">IN+</div>
            </li>

            <li <?if ($page_group_code=="00" ) {echo "class='active'" ;}?>>
                <a href="#"><i class="fa fa-th-large"></i><span class="nav-label">Dashboards</span> <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level <?if ($page_group_code != " 00") {echo "collapse" ;}?>">
                    <li <?if ($page_name=="index" ) {echo "class='active'" ;}?>><a href="index.php">Dashboard v.1</a></li>
            ...
            <li <?if ($page_group_code=="99" ) {echo "class='active'";}?>>
                <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">시스템관리</span></span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level <?if ($page_group_code != " 99") {echo "collapse" ;}?>">
                    <li <?if ($page_group_name=="group" ) {echo "class='active'" ;}?>><a href="group_list.php"">그룹관리</a></li>
                    <li <?if ($page_group_name=="member" ) {echo "class='active'" ;}?>><a href=" member_list.php">회원관리</a></li>
                </ul>
            </li>
            <!--<li>
                <a href="inspinia/mailbox.html"><i class="fa fa-envelope"></i> <span class="nav-label">Mailbox </span><span class="label label-warning pull-right">16/24</span></a>
            ...
            <li>
                <a href="inspinia/#"><i class="fa fa-edit"></i> <span class="nav-label">Forms</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse">
            ...
            <li>
                <a href="inspinia/#"><i class="fa fa-desktop"></i> <span class="nav-label">App Views</span>  <span class="pull-right label label-primary">SPECIAL</span></a>
                <ul class="nav nav-second-level collapse">
                    <li><a href="inspinia/contacts.html">Contacts</a></li>
                    <li><a href="inspinia/profile.html">Profile</a></li>
            ...
            <li>
                <a href="inspinia/#"><i class="fa fa-files-o"></i> <span class="nav-label">Other Pages</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse">
            ...
            <li>
                <a href="inspinia/#"><i class="fa fa-globe"></i> <span class="nav-label">Miscellaneous</span><span class="label label-info pull-right">NEW</span></a>
                <ul class="nav nav-second-level collapse">
            ...
            <li>
                <a href="inspinia/#"><i class="fa fa-flask"></i> <span class="nav-label">UI Elements</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse">
            ...
            <li>
                <a href="inspinia/#"><i class="fa fa-table"></i> <span class="nav-label">Tables</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse">
            ...
            <li>
                <a href="inspinia/#"><i class="fa fa-shopping-cart"></i> <span class="nav-label">E-commerce</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse">
            ...
            <li>
                <a href="inspinia/#"><i class="fa fa-picture-o"></i> <span class="nav-label">Gallery</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse">
            ...
            <li>
                <a href="inspinia/#"><i class="fa fa-sitemap"></i> <span class="nav-label">Menu Levels </span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse">
                    <li>
                        <a href="inspinia/#" id="damian">Third Level <span class="fa arrow"></span></a>
                        <ul class="nav nav-third-level">
                            <li>
                                <a href="inspinia/#">Third Level Item</a>
                            </li>
                            <li>
                                <a href="inspinia/#">Third Level Item</a>
                            </li>
                    ...
                    <li><a href="inspinia/#">Second Level Item</a></li>
                    <li>
                        <a href="inspinia/#">Second Level Item</a></li>
                    <li>
                        <a href="inspinia/#">Second Level Item</a></li>
                </ul>
            </li>
